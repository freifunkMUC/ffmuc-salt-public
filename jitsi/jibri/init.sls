...
google-chrome-repo-key:
  cmd.run:
    - name: "curl -fsSL https://dl-ssl.google.com/linux/linux_signing_key.pub | gpg --batch --yes --dearmor -o /usr/share/keyrings/google-chrome-keyring.gpg.tmp && mv /usr/share/keyrings/google-chrome-keyring.gpg.tmp /usr/share/keyrings/google-chrome-keyring.gpg"
