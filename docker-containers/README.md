...
of `top.sls` since December 2020, and the stack definitions it carried (Graylog
3.2, NetBox 2.5, Postgres 9.6, Mongo 3, Elasticsearch 6.6, openldap 1.2,
Zammad, Mattermost) had aged out entirely; they were removed rather than
carried forward. `git log` has them if any are ever needed again.
